...
| Этап | Описание | Время | Критичность | Статус |
|------|----------|-------|-------------|--------|
| **1** | Критические исправления биллинга | ~2-3 ч | 🔴 КРИТИЧНО | ✅ **ЗАВЕРШЕНО** |
| **2** | Модель данных и миграции | ~1-2 ч | 🟡 ВАЖНО | ✅ **ЗАВЕРШЕНО** |
| **3** | UX и валидация планов | ~2 ч | 🟢 УЛУЧШЕНИЯ | ✅ **ЗАВЕРШЕНО** |
| **4** | Рефакторинг и оптимизация | ~1 ч | 🔵 OPTIONAL | ✅ **ЗАВЕРШЕНО** |
...
- [x] Paddle API вызывается правильно для каждого типа плана
- [x] Computed properties работают  
- [x] История ONE_TIME покупок сохраняется
...
**Результат**: Все этапы успешно реализованы и протестированы
...
**Результат**: Система биллинга полностью исправлена и оптимизирована

## ✅ Выполненные работы:

### Этап 1 - Критические исправления ✅
- Блокировка ONE_TIME покупок при активной подписке
- Исправление webhook обработки
- Корректные счётчики использования
- Все критические тесты проходят

### Этап 2 - Модель данных ✅  
- Добавлены поля `is_default` и `one_time_requests_used`
- Созданы и применены миграции
- Исправлена регистрация пользователей
- База данных обновлена

### Этап 3 - UX и валидация ✅
- Создан эндпоинт `/billing/plans/available`
- Добавлена умная фильтрация планов
- Улучшена валидация при подписке
- Создан скрипт настройки по умолчанию

### Этап 4 - Рефакторинг ✅
- Разделены Paddle API вызовы по типам планов
- Добавлены computed properties для валидации
- Создана модель истории ONE_TIME покупок
